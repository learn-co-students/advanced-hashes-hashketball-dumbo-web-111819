...
def num_points_scored(said_name)
  game_hash.each do |_place, team|
    team.each do |attribute, data|
      next unless attribute == :players

      data.each do |player|
        return player[:points] if player[:player_name] == said_name
      end
    end
  end
end

def shoe_size(said_name)
  game_hash.each do |_place, team|
    team.each do |attribute, data|
      next unless attribute == :players

      data.each do |player|
        return player[:shoe] if player[:player_name] == said_name
      end
    end
  end
end
  ...
  game_hash.collect do |place, team|
    team.each do |attribute, _data|
      ...
      game_hash[place][attribute].each do |player|
        next unless player[:player_name] == said_name
